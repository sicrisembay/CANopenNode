...
#if (C2000_PORT != 0)
    SYNC->OD_1006_period = OD_getPtr(OD_1006_commCyclePeriod, 0, 4U, NULL);
#else
...
#if (C2000_PORT != 0)
    SYNC->OD_1007_window = OD_getPtr(OD_1007_syncWindowLen, 0, 4U, NULL);
#else
